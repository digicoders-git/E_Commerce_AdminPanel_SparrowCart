    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="rounded-2xl p-5 border shadow-sm hover:shadow-md transition-all group" style={{ backgroundColor: themeColors.surface, borderColor: themeColors.border }}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest opacity-60 mb-1" style={{ color: themeColors.text }}>Total Stores</p>
        ...
        <div className="rounded-2xl p-5 border shadow-sm hover:shadow-md transition-all group" style={{ backgroundColor: themeColors.surface, borderColor: themeColors.border }}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest opacity-60 mb-1" style={{ color: themeColors.text }}>Active Stores</p>
        ...
        <div className="rounded-2xl p-5 border shadow-sm hover:shadow-md transition-all group" style={{ backgroundColor: themeColors.surface, borderColor: themeColors.border }}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest opacity-60 mb-1" style={{ color: themeColors.text }}>Total Products</p>
              <p className="text-3xl font-black text-purple-600">{totalProductsAssigned}</p>
            </div>
            <div className="p-4 rounded-2xl bg-purple-500 shadow-lg shadow-purple-500/20 group-hover:scale-110 transition-transform">
        ...
        <div className="rounded-2xl p-5 border shadow-sm hover:shadow-md transition-all group" style={{ backgroundColor: themeColors.surface, borderColor: themeColors.border }}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest opacity-60 mb-1" style={{ color: themeColors.text }}>Inactive Stores</p>
        ...
        <div className="rounded-2xl p-5 border shadow-sm hover:shadow-md transition-all group" style={{ backgroundColor: themeColors.surface, borderColor: themeColors.border }}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest opacity-60 mb-1" style={{ color: themeColors.text }}>Cities</p>
              <p className="text-3xl font-black text-teal-600">{uniqueCities}</p>
            </div>
            <div className="p-4 rounded-2xl bg-teal-500 shadow-lg shadow-teal-500/20 group-hover:scale-110 transition-transform">
              <FaCity size={24} className="text-white" />
            </div>
          </div>
        </div>
      </div>
